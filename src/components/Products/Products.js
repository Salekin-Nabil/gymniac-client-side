...
const Products = () => {
    ...
    return (
        <div id='products'>
            ...
            <button onClick={()=>navigate('/Manage')} className='rounded-3xl text-white text-2xl font-semibold bg-[#607c14] active:bg-[#506a09] focus:bg-[#4a6402] hover:bg-[#344506] shadow-lg shadow-white hover:shadow-xl hover:shadow-white mt-10 py-2 px-20 md:px-60'>Manage Inventory</button>
        </div>
    );
};
