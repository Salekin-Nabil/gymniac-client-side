                ...
                <div className="container px-6 py-12 h-full">
                    ...
                    <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
                        ...
                        <div className='flex items-center mt-6'>
                            ...
                            <Link to="/Login" className="text-[#96be25] ml-2 hover:text-yellow-400 focus:text-yellow-500 active:text-[#96be25] duration-200 transition ease-in-out">Login</Link>
                        </div>
                        </form>
                    </div>
                    </div>
